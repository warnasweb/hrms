...
<body >
 <form id="candidateForm" action="${pageContext.request.contextPath}/candidateController/saveCandidate.htm" name="CandidateForm" method="Post" enctype="multipart/form-data">
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<textarea  rows="3" cols="20" name="skills" id="skills"></textarea>
							  </td>
						...
						<tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<input type="text" name="noticePeriod" id="noticePeriod" size="3" value=""> (days)
							  </td>
                            </tr>
                          </table></td>
						...
						<tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<input type="text" name="currentCTC" id="currentCTC" size="5"  value=""> (lacs)
							  </td>
                            </tr>
                          </table></td>
						...
						<tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<input type="text" name="expectedCTC" id="expectedCTC" size="5" value=""> (lacs)
							  </td>
                            </tr>
                          </table></td>
