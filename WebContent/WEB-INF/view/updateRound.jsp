					...
					<table width="98%" border="0"  align="center" cellpadding="0" cellspacing="0">
                          ...
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<input type="text" readonly="readonly" name="round" id="round" value="${roundFrm.round}">
								<input type="hidden" name="candidateID" id="candidateID" value="">
								<input type="hidden" name="id" id="id" value="${roundFrm.id}">
							  </td>
                            </tr>
                          </table></td>
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<input type="text" name="dateOfInterview" id="dateOfInterview" size="10" maxlength="10" value="${roundFrm.doi}"> 
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<textarea  rows="4" cols="20" name="remarks" id="remarks">${roundFrm.remarks}</textarea>
							  </td>
                            </tr>
                          </table></td>
                        </tr>
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="70%" align="left">
								<textarea onkeypress="limitText(this)" rows="4" cols="20" name="result" id="result">${roundFrm.result}</textarea>
							  </td>
                              ...
                              <td width="70%" align="left">
								<select name="panelID" id="panelID">
									...
									<c:forEach items="${panelMap}" var="panels" > 
										...
										<option value="${panels.key }" <c:if test="${panels.key eq roundFrm.panelID}">selected="selected"</c:if>  >${panels.value }</option>
									</c:forEach>
								</select>
							  </td>
                        ...
                        <tr>
						  ...
						  <td  class="box1" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
							<td align="right">
							<input type="button" value="" onclick="saveRound(this.form, 'updateRound')" style="" class="sub_btn"/>
							<td>&nbsp;</td>
