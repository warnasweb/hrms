...
function savePanel9(frm, type){
	frm.submit();
}
function savePanel(frm, type){
	var callingUrl="";
	if(type=='save'){
		callingUrl="savePanel.htm"
	}else if(type=='update'){
		callingUrl="updatePanel.htm"
	}
...
<body >
	...
	<div id="maintbl">
		...
		<td width="20%" align="center"><div class="button_red"><a href="javascript:openPopup('openNewPanel.htm')" >Add New Panel</a></div></td></tr>
		</table>
		<div id="detailDiv">
				<jsp:include page="panelList.jsp"/>		
		</div>
		<br/>
