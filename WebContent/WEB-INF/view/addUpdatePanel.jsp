					...
					<table width="98%" border="0"  align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="60%" align="left">
								<input type="text" name="firstName" id="firstName" value="${panel.firstName }">
								<c:if test="${frmType eq 'edit'}">
									<input type="hidden" name="id" id="id" value="${panel.id }">
								</c:if>
							  </td>
                            </tr>
                          </table></td>
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="60%" align="left">
								<input type="text" name="lastName" id="lastName" value="${panel.lastName }">
							  </td>
                            </tr>
                          </table></td>
						 ...
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="60%" align="left">
								<input type="text" name="email" id="email" value="${panel.email }">
							  </td>
                            </tr>
                          </table></td>
                        </tr>
						 <tr>
                          <td  width="100%" colspan="2" class="box2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="40%" align="left" class="greybox15text">Designation: </td>
                              <td width="60%" align="left">
								<input type="text" name="designation" id="designation" value="${panel.designation }">
							  </td>
                        ...
                        <tr>
						  ...
						  <td  class="box1" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
							<td align="right">
							<input type="button" value="" onclick="savePanel(this.form, '${frmType == 'new' ? 'save' : 'update'}')" style="" class="sub_btn"/>
							</td>
							<td>&nbsp;</td>
